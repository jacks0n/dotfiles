...
-- if not lspconfig.serverless then
--   configs.serverless = {
--     default_config = {
--       cmd = {'node', '/opt/homebrew/lib/node_modules/@serverless-ide/language-server/dist/server.js', '--stdio'};
--       filetypes = {'serverless', 'serverless.yaml'};
